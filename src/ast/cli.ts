...
export const commandLineOptions: OptionDefinition[] = [
    ...
    },
    {
        ...
        type: String,
        typeLabel: '{underline file}',
        description: 'An input grammar file (.grm) containing the grammar definition to use during parsing. If not specified, the default grammar will be used.'
    },
    {
    ...
    },
    {
        ...
        description: 'Provide an inline string input instead of a file to parse. If using this option, the {underline input} option may be omitted.'
    },
    {
        name: 'parse-table',
        typeLabel: '{underline file}',
    ...
    const sections = [
        {
            ...
            content: 'Generates an Abstract Syntax Tree from the given input using the provided grammar.'
        },
        {
            header: 'Usage',
            content: [
