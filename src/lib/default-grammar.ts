...
StructDeclaration -> 'struct' 'id' OptStructInheritanceList '{' StructMemberDeclarationList '}' ';' {{ return { type: $$, name: $2, inheritanceList: $3, body: $5 }; }}

StructInheritanceList -> 'inherits' 'id' ReptStructInheritanceList {{ return [$2, ...$3]; }}
OptStructInheritanceList -> StructInheritanceList {{ return $1; }}
OptStructInheritanceList -> ε {{ return []; }}
ReptStructInheritanceList -> ',' 'id' ReptStructInheritanceList {{ return [$2, ...$3]; }}
...
Visibility -> 'private' | 'public' {{ return $1; }}
...
FunctionDeclarationInit -> 'func' 'id' '(' OptFunctionParameterList ')' '->' ReturnType {{ return { type: $$, name: $2, parameters: $4, returnType: $7 }; }}
...
FunctionParameter -> 'id' ':' Type ReptArraySize {{ return { type: $$, name: $1, varType: $3, arraySizes: $4 }; }}

ArraySize -> '[' OptIntLiteral ']' {{ return $2; }}
ReptArraySize -> ArraySize ReptArraySize {{ return [$1, ...$2]; }}
ReptArraySize -> ε {{ return []; }}

OptIntLiteral -> 'int_literal' {{ return $1; }}
OptIntLiteral -> ε {{ return 0; }}

VariableDeclaration -> 'let' 'id' ':' Type ReptArraySize ';' {{ return { type: $$, name: $2, varType: $4, arraySizes: $5 }; }}

ImplDeclaration -> 'impl' 'id' '{' FunctionDefinitionList '}' {{ return { type: $$, name: $2, body: $4 }; }}
...
IfStatement -> 'if' '(' LogicalORExpression ')' 'then' OptFunctionStatement 'else' OptFunctionStatement ';' {{ return { type: $$, condition: $3, ifBody: $6, elseBody: $8 }; }}

WhileStatement -> 'while' '(' LogicalORExpression ')' OptFunctionStatement ';' {{ return { type: $$, condition: $3, body: $5 }; }}

ReadStatement -> 'read' '(' CallMemberExpression ')' ';' {{ return { type: $$, expression: $3 }; }}

WriteStatement -> 'write' '(' LogicalORExpression ')' ';' {{ return { type: $$, expression: $3 }; }}

ReturnStatement -> 'return' '(' LogicalORExpression ')' ';' {{ return { type: $$, expression: $3 }; }}
...
ReptLogicalORExpression -> 'or_op' LogicalANDExpression ReptLogicalORExpression {{ return [{ op: $1, ...$2 }, ...$3]; }}
...
ReptLogicalANDExpression -> 'and_op' EqualityExpression ReptLogicalANDExpression {{ return [{ op: $1, ...$2 }, ...$3]; }}
...
ReptEqualityExpression -> 'eq_op' RelationalExpression ReptEqualityExpression {{ return [{ op: $1, ...$2 }, ...$3]}}
...
ReptRelationalExpression -> 'rel_op' AdditiveExpression ReptRelationalExpression {{ return [{ op: $1, ...$2 }, ...$3]}}
...
ReptAdditiveExpression -> 'add_op' MultiplicativeExpression ReptAdditiveExpression {{ return [{ op: $1, ...$2 }, ...$3]}}
...
ReptMultiplicativeExpression -> 'mul_op' UnaryExpression ReptMultiplicativeExpression {{ return [{ op: $1, ...$2 }, ...$3]}}
ReptMultiplicativeExpression -> ε {{ return []; }}

UnaryExpression -> LeftHandSideExpression {{ return $1; }}
UnaryExpression -> 'add_op' UnaryExpression {{ return { type: $$, operator: $1, expression: $2 }; }}
UnaryExpression -> 'not_op' UnaryExpression {{ return { type: $$, operator: $1, expression: $2 }; }}

LeftHandSideExpression -> CallMemberExpression | PrimaryExpression {{ return $1; }}

CallMemberExpression -> 'id' MemberIndexCall ReptCallMemberExpression {{ return { type: 'IdentifierExpression', ...$2, identifier: $1, chainedExpression: $3 }; }}

ReptCallMemberExpression -> '.' 'id' MemberIndexCall ReptCallMemberExpression {{ return { type: 'IdentifierExpression', ...$3, identifier: $2, chainedExpression: $4 }; }}
...
Literal -> 'int_literal' {{ return { type: 'IntegerLiteral', value: $1 }; }}
Literal -> 'float_literal' {{ return { type: 'FloatLiteral', value: $1 }; }}
