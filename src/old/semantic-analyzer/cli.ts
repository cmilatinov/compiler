    ...
    const sections = [
        {
            ...
            content:
                'Verifies that the provided source file is semantically correct and generates its corresponding symbol tables.'
        },
        {
            header: 'Usage',
            content: [
                {
                    desc: 'Analysis',
                    example: '$ semanticanalyzerdriver {underline input} [options ...]'
                },
